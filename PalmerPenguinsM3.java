...
// Andrea Villarreal
// 31May2026
// Program displays branching analysis of Palmer Penguins
...
public class PalmerPenguinsM3 {
    ...
    public static void main(String[] args) {
        ...
        // output the most populous penguin species                  
        System.out.println();
        System.out.println("Branching Analysis:");
                                            
        if (NUM_CHINSTRAP > NUM_GENTOO && NUM_CHINSTRAP > NUM_ADELIE) {
            System.out.println(SP_CHINSTRAP + " penguins are the most" +
                           " populous.");
        }
        ...
        // output switch statement analysis
        System.out.println();
